...
export class ColorConfig {
	...
	public static readonly defaultTheme: string = "lemmbox dark";
...
`,
    ...
    --secondary-text: #900;
    --inverted-text: black;
    --text-selection: rgba(119, 0, 0, 0.99);
    --box-selection-fill: rgba(255, 0, 0, 0.2);
    --loop-accent: #700;
    --link-accent: #900;
    --ui-widget-background: #400;
    --ui-widget-focus: #700;
    --pitch-background: #400;
    --tonic: #800;
    --fifth-note: #400;
    --white-piano-key: #b00;
    --black-piano-key: #400;
    --white-piano-key-text: #130000;
    --black-piano-key-text: #f00;
    --use-color-formula: false;
    --track-editor-bg-pitch: #400;
    --track-editor-bg-pitch-dim: #300;
    --track-editor-bg-noise: #400;
    --track-editor-bg-noise-dim: #300;
    --track-editor-bg-mod: #200;
    --track-editor-bg-mod-dim: #100;
    --multiplicative-mod-slider: #400;
    --overwriting-mod-slider: #600;
    --indicator-primary: #700;
    --indicator-secondary: #400;
    --select2-opt-group: #580000;
    --input-box-outline: #300;
    --mute-button-normal: #ff0000;
    --mute-button-mod: #9a0000;
    --pitch1-secondary-channel: #990000;
    --pitch1-primary-channel: #250000;
    --pitch1-secondary-note: #bd0000;
    --pitch1-primary-note: #920000;
    --pitch2-secondary-channel: #a10000;
    --pitch2-primary-channel: #ff0000;
    --pitch2-secondary-note: #c70000;
    --pitch2-primary-note: #ff0000;
    --pitch3-secondary-channel: #c70000;
    --pitch3-primary-channel: #ff0000;
    --pitch3-secondary-note: #ff0000;
    --pitch3-primary-note: #ff0000;
    --pitch4-secondary-channel: #a10000;
    --pitch4-primary-channel: #500000;
    --pitch4-secondary-note: #c70000;
    --pitch4-primary-note: #a00000;
    --pitch5-secondary-channel: #d00000;
    --pitch5-primary-channel: #ff0000;
    --pitch5-secondary-note: #e00000;
    --pitch5-primary-note: #ff0000;
    --pitch6-secondary-channel: #770000;
    --pitch6-primary-channel: #a00000;
    --pitch6-secondary-note: #880000;
    --pitch6-primary-note: #d00000;
    --pitch7-secondary-channel: #8a0000;
    --pitch7-primary-channel: #de0000;
    --pitch7-secondary-note: #aa0000;
    --pitch7-primary-note: #e60000;
    --pitch8-secondary-channel: #df0000;
    --pitch8-primary-channel: #ff0000;
    --pitch8-secondary-note: #ff0000;
    --pitch8-primary-note: #ff0000;
    --pitch9-secondary-channel: #000000;
    --pitch9-primary-channel: #500000;
    --pitch9-secondary-note: #c70000;
    --pitch9-primary-note: #830000;
    --pitch10-secondary-channel: #a10000;
    --pitch10-primary-channel: #ce0000;
    --pitch10-secondary-note: #b70000;
    --pitch10-primary-note: #df0000;
    --noise1-secondary-channel: #6f0000;
    --noise1-primary-channel: #aa0000;
    --noise1-secondary-note: #a70000;
    --noise1-primary-note: #e00000;
    --noise2-secondary-channel: #990000;
    --noise2-primary-channel: #dd0000;
    --noise2-secondary-note: #cc0000;
    --noise2-primary-note: #f00000;
    --noise3-secondary-channel: #4a0000;
    --noise3-primary-channel: #770000;
    --noise3-secondary-note: #6f0000;
    --noise3-primary-note: #bb0000;
    --noise4-secondary-channel: #7a0000;
    --noise4-primary-channel: #af0000;
    --noise4-secondary-note: #9e0000;
    --noise4-primary-note: #d40000;
    --noise5-secondary-channel: #600000;
    --noise5-primary-channel: #a20000;
    --noise5-secondary-note: #910000;
    --noise5-primary-note: #c50000;
    --mod1-secondary-channel: #330000;
    --mod1-primary-channel: #770000;
    --mod1-secondary-note: #770000;
    --mod1-primary-note: #cd0000;
    --mod2-secondary-channel: #990000;
    --mod2-primary-channel: #f00000;
    --mod2-secondary-note: #f00000;
    --mod2-primary-note: #ff0000;
    --mod3-secondary-channel: #550000;
    --mod3-primary-channel: #880000;
    --mod3-secondary-note: #aa0000;
    --mod3-primary-note: #f80000;
    --mod4-secondary-channel: #a80000;
    --mod4-primary-channel: #c80000;
    --mod4-secondary-note: #e80000;
    --mod4-primary-note: #ff0000;
    --mod-label-primary: #900;
    --mod-label-secondary-text: #300;
    --mod-label-primary-text: black;
    --disabled-note-primary: #900;
    --disabled-note-secondary: #600;
}`,
"green":`
:root {
    --page-margin: black;
    ...
    --secondary-text: #090;
    --inverted-text: black;
    --text-selection: rgba(0, 119, 0, 0.99);
    --box-selection-fill: rgba(0, 255, 0, 0.2);
    --loop-accent: #070;
    --link-accent: #090;
    --ui-widget-background: #040;
    --ui-widget-focus: #070;
    --pitch-background: #040;
    --tonic: #080;
    --fifth-note: #040;
    --white-piano-key: #0b0;
    --black-piano-key: #040;
    --white-piano-key-text: #001300;
    --black-piano-key-text: #0f0;
    --use-color-formula: false;
    --track-editor-bg-pitch: #040;
    --track-editor-bg-pitch-dim: #030;
    --track-editor-bg-noise: #040;
    --track-editor-bg-noise-dim: #030;
    --track-editor-bg-mod: #020;
    --track-editor-bg-mod-dim: #010;
    --multiplicative-mod-slider: #040;
    --overwriting-mod-slider: #060;
    --indicator-primary: #070;
    --indicator-secondary: #040;
    --select2-opt-group: #005800;
    --input-box-outline: #030;
    --mute-button-normal: #00ff00;
    --mute-button-mod: #009a00;
    --pitch1-secondary-channel: #009900;
    --pitch1-primary-channel: #002500;
    --pitch1-secondary-note: #00bd00;
    --pitch1-primary-note: #009200;
    --pitch2-secondary-channel: #00a100;
    --pitch2-primary-channel: #00ff00;
    --pitch2-secondary-note: #00c700;
    --pitch2-primary-note: #00ff00;
    --pitch3-secondary-channel: #00c700;
    --pitch3-primary-channel: #00ff00;
    --pitch3-secondary-note: #00ff00;
    --pitch3-primary-note: #00ff00;
    --pitch4-secondary-channel: #00a100;
    --pitch4-primary-channel: #005000;
    --pitch4-secondary-note: #00c700;
    --pitch4-primary-note: #00a000;
    --pitch5-secondary-channel: #00d000;
    --pitch5-primary-channel: #00ff00;
    --pitch5-secondary-note: #00e000;
    --pitch5-primary-note: #00ff00;
    --pitch6-secondary-channel: #007700;
    --pitch6-primary-channel: #00a000;
    --pitch6-secondary-note: #008000;
    --pitch6-primary-note: #00d000;
    --pitch7-secondary-channel: #008a00;
    --pitch7-primary-channel: #00de00;
    --pitch7-secondary-note: #00aa00;
    --pitch7-primary-note: #00e600;
    --pitch8-secondary-channel: #00df00;
    --pitch8-primary-channel: #00ff00;
    --pitch8-secondary-note: #00ff00;
    --pitch8-primary-note: #00ff00;
    --pitch9-secondary-channel: #000000;
    --pitch9-primary-channel: #005000;
    --pitch9-secondary-note: #00c700;
    --pitch9-primary-note: #008300;
    --pitch10-secondary-channel: #00a100;
    --pitch10-primary-channel: #00ce00;
    --pitch10-secondary-note: #00b700;
    --pitch10-primary-note: #00df00;
    --noise1-secondary-channel: #006f00;
    --noise1-primary-channel: #00aa00;
    --noise1-secondary-note: #00a700;
    --noise1-primary-note: #00e000;
    --noise2-secondary-channel: #009900;
    --noise2-primary-channel: #00dd00;
    --noise2-secondary-note: #00cc00;
    --noise2-primary-note: #00f000;
    --noise3-secondary-channel: #004a00;
    --noise3-primary-channel: #007700;
    --noise3-secondary-note: #006f00;
    --noise3-primary-note: #00bb00;
    --noise4-secondary-channel: #007a00;
    --noise4-primary-channel: #00af00;
    --noise4-secondary-note: #009e00;
    --noise4-primary-note: #00d400;
    --noise5-secondary-channel: #006000;
    --noise5-primary-channel: #00a200;
    --noise5-secondary-note: #009100;
    --noise5-primary-note: #00c500;
    --mod1-secondary-channel: #003300;
    --mod1-primary-channel: #007700;
    --mod1-secondary-note: #007700;
    --mod1-primary-note: #00cd00;
    --mod2-secondary-channel: #009900;
    --mod2-primary-channel: #00f000;
    --mod2-secondary-note: #00f000;
    --mod2-primary-note: #00ff00;
    --mod3-secondary-channel: #005500;
    --mod3-primary-channel: #008800;
    --mod3-secondary-note: #00aa00;
    --mod3-primary-note: #00f800;
    --mod4-secondary-channel: #00a800;
    --mod4-primary-channel: #00c800;
    --mod4-secondary-note: #00e800;
    --mod4-primary-note: #00ff00;
    --mod-label-primary: #090;
    --mod-label-secondary-text: #030;
    --mod-label-primary-text: black;
    --disabled-note-primary: #090;
    --disabled-note-secondary: #060;
}`,
"blue":`
:root {
    --page-margin: black;
    ...
    --secondary-text: #009;
    --inverted-text: black;
    --text-selection: rgba(0, 0, 119, 0.99);
    --box-selection-fill: rgba(0, 0, 255, 0.2);
    --loop-accent: #007;
    --link-accent: #009;
    --ui-widget-background: #004;
    --ui-widget-focus: #007;
    --pitch-background: #004;
    --tonic: #008;
    --fifth-note: #004;
    --white-piano-key: #00b;
    --black-piano-key: #004;
    --white-piano-key-text: #000013;
    --black-piano-key-text: #00f;
    --use-color-formula: false;
    --track-editor-bg-pitch: #004;
    --track-editor-bg-pitch-dim: #003;
    --track-editor-bg-noise: #004;
    --track-editor-bg-noise-dim: #003;
    --track-editor-bg-mod: #002;
    --track-editor-bg-mod-dim: #001;
    --multiplicative-mod-slider: #004;
    --overwriting-mod-slider: #006;
    --indicator-primary: #007;
    --indicator-secondary: #004;
    --select2-opt-group: #000058;
    --input-box-outline: #003;
    --mute-button-normal: #0000ff;
    --mute-button-mod: #00009a;
    --pitch1-secondary-channel: #000099;
    --pitch1-primary-channel: #000025;
    --pitch1-secondary-note: #0000bd;
    --pitch1-primary-note: #000092;
    --pitch2-secondary-channel: #0000a1;
    --pitch2-primary-channel: #0000ff;
    --pitch2-secondary-note: #0000c7;
    --pitch2-primary-note: #0000ff;
    --pitch3-secondary-channel: #0000c7;
    --pitch3-primary-channel: #0000ff;
    --pitch3-secondary-note: #0000ff;
    --pitch3-primary-note: #0000ff;
    --pitch4-secondary-channel: #0000a1;
    --pitch4-primary-channel: #000050;
    --pitch4-secondary-note: #0000c7;
    --pitch4-primary-note: #0000a0;
    --pitch5-secondary-channel: #0000d0;
    --pitch5-primary-channel: #0000ff;
    --pitch5-secondary-note: #0000e0;
    --pitch5-primary-note: #0000ff;
    --pitch6-secondary-channel: #000070;
    --pitch6-primary-channel: #0000a0;
    --pitch6-secondary-note: #000080;
    --pitch6-primary-note: #0000d0;
    --pitch7-secondary-channel: #00008a;
    --pitch7-primary-channel: #0000de;
    --pitch7-secondary-note: #0000aa;
    --pitch7-primary-note: #0000e6;
    --pitch8-secondary-channel: #0000df;
    --pitch8-primary-channel: #0000ff;
    --pitch8-secondary-note: #0000ff;
    --pitch8-primary-note: #0000ff;
    --pitch9-secondary-channel: #000000;
    --pitch9-primary-channel: #000050;
    --pitch9-secondary-note: #0000c7;
    --pitch9-primary-note: #000083;
    --pitch10-secondary-channel: #0000a1;
    --pitch10-primary-channel: #0000ce;
    --pitch10-secondary-note: #0000b7;
    --pitch10-primary-note: #0000df;
    --noise1-secondary-channel: #00006f;
    --noise1-primary-channel: #0000a0;
    --noise1-secondary-note: #0000a7;
    --noise1-primary-note: #0000e0;
    --noise2-secondary-channel: #000099;
    --noise2-primary-channel: #0000dd;
    --noise2-secondary-note: #0000cc;
    --noise2-primary-note: #0000f0;
    --noise3-secondary-channel: #00004a;
    --noise3-primary-channel: #000077;
    --noise3-secondary-note: #00006f;
    --noise3-primary-note: #0000bb;
    --noise4-secondary-channel: #00007a;
    --noise4-primary-channel: #0000af;
    --noise4-secondary-note: #00009e;
    --noise4-primary-note: #0000d4;
    --noise5-secondary-channel: #000060;
    --noise5-primary-channel: #0000a2;
    --noise5-secondary-note: #000091;
    --noise5-primary-note: #0000c5;
    --mod1-secondary-channel: #000033;
    --mod1-primary-channel: #000077;
    --mod1-secondary-note: #000077;
    --mod1-primary-note: #0000cd;
    --mod2-secondary-channel: #000099;
    --mod2-primary-channel: #0000f0;
    --mod2-secondary-note: #0000f0;
    --mod2-primary-note: #0000ff;
    --mod3-secondary-channel: #000055;
    --mod3-primary-channel: #000088;
    --mod3-secondary-note: #0000aa;
    --mod3-primary-note: #0000f8;
    --mod4-secondary-channel: #0000a8;
    --mod4-primary-channel: #0000c8;
    --mod4-secondary-note: #0000e8;
    --mod4-primary-note: #0000ff;
    --mod-label-primary: #009;
    --mod-label-secondary-text: #003;
    --mod-label-primary-text: black;
    --disabled-note-primary: #009;
    --disabled-note-secondary: #006;
}`,
"death": `
	:root {
		--page-margin: #112335;
			...
			--playhead: #AABBFF;
			--secondary-text: #DDDDFF;
			--box-selection-fill: rgba(255,255,255,0.2);
			--ui-widget-background: #228;
			--ui-widget-focus: #77B;
			--pitch-background: #339;
			--tonic: #468;
			--fifth-note: #236;
			--white-piano-key: #bbF;
			--black-piano-key: #44A;
			--use-color-formula: true;
			--track-editor-bg-pitch: #393aaf;
			--track-editor-bg-pitch-dim: #1c289a;
			--track-editor-bg-noise: #2c353F;
			--track-editor-bg-noise-dim: #16131B;
			--track-editor-bg-mod: #28356a;
			--track-editor-bg-mod-dim: #0a101f;
			--multiplicative-mod-slider: #606a9f;
			--overwriting-mod-slider: #6850ba;
			--indicator-primary: #9c64f7;
			--indicator-secondary: #393e4f;
			--select2-opt-group: #5d576f;
			--input-box-outline: #22a;
			--mute-button-normal: #2Ea8ad;
			--mute-button-mod: #886eae;
			--mod-label-primary: #28284a;
			--mod-label-secondary-text: rgb(87, 86, 120);
			--mod-label-primary-text: white;
			--pitch-secondary-channel-hue: 0;
			--pitch-secondary-channel-hue-scale: 6.5;
